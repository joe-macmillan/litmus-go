...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	experimentDetails.ExperimentName = types.Getenv("EXPERIMENT_NAME", "kubelet-svc-kill-rancher")
	...
	experimentDetails.KillCommand = types.Getenv("KILL_COMMAND", "sudo docker kill kubelet")
